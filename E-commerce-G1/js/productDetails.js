...
//container for the quantity of items
  ...
  let addToCartTextNode = document.createTextNode('Agregar al Carrito ');
  ...
  let h3DescTextNode = document.createTextNode('Descripción');
...
function buildComments(root, comment){
  ...
  img.src='https://i.gifer.com/origin/be/be03b4119b4b5bf98069a967546a8a91_w200.webp';
  ...
  let iTextNode = document.createTextNode('Posteado el: ' + comment.val().date);
